...
def main():
    ...
    transitions = {
        ...
        ('qkurunghead', 'EM_OPEN', 'D'): ('qem', ('M', 'D')),
        ('qkurunghead', 'EM_OPEN', 'E'): ('qem', ('M', 'E')),
        ...
        ('qkurunghead', 'B_OPEN', 'D'): ('qb', ('O', 'D')),
        ('qkurunghead', 'B_OPEN', 'E'): ('qb', ('O', 'E')),
        ...
        ('qkurunghead', 'ABBR_OPEN', 'D'): ('qabbr', ('P', 'D')),
        ('qkurunghead', 'ABBR_OPEN', 'E'): ('qabbr', ('P', 'E')),
        ...
        ('qkurunghead', 'STRONG_OPEN', 'D'): ('qstrong', ('Q', 'D')),
        ('qkurunghead', 'STRONG_OPEN', 'E'): ('qstrong', ('Q', 'E')),
        ...
        ('qkurunghead', 'SMALL_OPEN', 'D'): ('qsmall', ('R', 'D')),
        ('qkurunghead', 'SMALL_OPEN', 'E'): ('qsmall', ('R', 'E')),
        ('qkurungbody', 'SMALL_OPEN', 'E'): ('qsmall', ('R', 'E')),
